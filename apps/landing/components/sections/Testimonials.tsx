...
export function Testimonials() {
  ...
  return (
    <section className="py-20 px-4" style={{ background: '#FFF5F5' }} aria-labelledby="testimonials-title">
            ...
            >
              ...
              <div className="flex items-center gap-3 border-t pt-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">{t.date} · Theme {t.theme}</p>
                </div>
